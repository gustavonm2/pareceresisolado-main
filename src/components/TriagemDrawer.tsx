                                ...
                                <div className="flex gap-2">
                                    {(['Alta', 'Média', 'Baixa'] as const).map(p => (
                                        <button
                                            ...
                                            className={`flex-1 py-2 rounded-lg border text-[11px] font-bold transition-all ${priority === p ? priorityColors[p] + ' shadow-sm' : 'border-[#E2E8F0] bg-white text-[#94A3B8] hover:border-[#CBD5E1]'}`}
                                        >
                                            {p}
                                        </button>
                                    ))}
